...
//    public mobil( double jarak, double waktu) {
//        this.jarak = jarak;
//        this.waktu = waktu;
//    }

//    public mobil(double kec_saatini, double kec_max) {
//        this.kec_saatini = kec_saatini;
//        this.kec_max = kec_max;
//    }
    
    public mobil(double maxkecepatan) {
        this.maxkecepatan = maxkecepatan;
    }
    
    @Override
    public String getnama() {
        System.out.println("Nama Kendaraan  : Mobil");
        return null;
    }
